  ...
  messages: {
    ayuvera404: {
      ...
      letter: `
        ...
        I'm forever grateful for it. I also found the Enstars tierlist that you and Kelp made together hilarious… 
    ...
    kace: {
      name: 'Kace',
      letter: `
        Kace! To think that you were degen filling for me during Painful Hope, and now you're here being one of my assistant managers for Babuka! This is sort of emotional for me, seeing that you and a few other of the managers and assistant managers were there for both of my runs. Thank you for indulging into the Hokke theme and becoming Hokke's dad after sending a gif of him. Again, I learnt many new things about you this run… Including the bit that you used to play Merge Mansion… Who knew? Thank you for making this run possible, as well as making sure that rooms were running well during the times that CC bugs happened (especially that one hour where I kept getting booted from the room, wahhhh). I'll be there to fill for you during Light Up the Fire and for that possible Shizu3 run? Yea? Yea? Shizu3? Anyways, I'm super grateful that you wanted to help out for my run.
      `,
    },
    sera: {
      name: 'Sera',
      letter: `
        Seba… Thank you for also encouraging me to find new managers as well as being one of the first people to even volunteer to manage for me. You also were one of the first people to suggest that I'd theme the server around Hokke, and even took the idea above and beyond for me (I will never forget the suggestion that we use the sasaracreamsoda image being used for checkin…).  I'm glad that you encouraged me and definitely were there during the hours where I was definitely struggling in CC. Thank you so much for basically living in VC with me during this entire run, no words can explain how grateful I am for you. I know that the start dash didn't go as anticipated, and I'm really sorry for it, but I know that you'll be running a marathon, so I can let out a small sigh of relief.  I'll be there for you during Babukana, will help be an assistant manager for your run, like you did for me <33 but for now… bawls in your jawls.
      `,
    },
    chi: {
      name: 'Chi',
